...
public interface IField
{
    ...
    /**
     * Checks whether a specific board position is available for input. It
     * checks whether the board position is available for play in the macroboard
     * (3x3), where it is marked using the AVAILABLE_FIELD character.
     *
     * @param x
     * @param y
     * @return Returns true if the board position at (x,y) is available for
